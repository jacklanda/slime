...
def select_task_family_quota_groups(groups: list[list[Sample]], target: int, quota_spec) -> list[list[Sample]]:
    ...
    for family, count in counts.items():
        ...
        for idx, group in enumerate(groups):
            if idx in selected_ids or sample_group_task_family(group) != family:
                continue
