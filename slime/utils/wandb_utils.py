...
def _init_wandb_common():
    ...
    with warnings.catch_warnings():
        ...
        wandb.define_metric("response_length/*", step_metric="rollout/step")
        wandb.define_metric("prompt_length/*", step_metric="rollout/step")
        wandb.define_metric("response/*", step_metric="rollout/step")
