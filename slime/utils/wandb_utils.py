...
def _init_wandb_common():
    ...
    with warnings.catch_warnings():
        ...
        wandb.define_metric("multi_turn/*", step_metric="train/step")
        wandb.define_metric("passrate/*", step_metric="train/step")
        wandb.define_metric("eval/step")
        wandb.define_metric("eval/*", step_metric="train/step")
        wandb.define_metric("perf/*", step_metric="train/step")
        wandb.define_metric("timing_s/*", step_metric="train/step")
        wandb.define_metric("timing_per_token_ms/*", step_metric="train/step")
        wandb.define_metric("response_length/*", step_metric="train/step")
        wandb.define_metric("prompt_length/*", step_metric="train/step")
